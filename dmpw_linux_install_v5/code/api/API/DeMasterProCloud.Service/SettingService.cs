    ...
    public class SettingService : ISettingService
    {
        ...
        public LocalMqttSetting GetLocalMqttSetting(int companyId)
        {
            ...
            try
            {
                ...
                // SECURITY: setting.Password is loaded from database/configuration, not hardcoded.
                // GetValueFromKey retrieves externalized configuration value. False positive warning.
