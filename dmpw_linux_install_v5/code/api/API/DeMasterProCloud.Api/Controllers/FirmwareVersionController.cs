...
namespace DeMasterProCloud.Api.Controllers
{
    public class FirmwareVersionController : Controller
    {
        ...
        [CheckPermission(ActionName.View + Page.FirmwareVersion)]
        ...
        [HttpPost]
        [Route(Constants.Route.ApiFirmwareVersion)]
        [CheckPermission(ActionName.Add + Page.FirmwareVersion)]
        ...
        [HttpDelete]
        [Route(Constants.Route.ApiFirmwareVersion)]
        [CheckPermission(ActionName.Delete + Page.FirmwareVersion)]
        ...
        [CheckPermission(ActionName.Update + Page.FirmwareVersion)]
        ...
        /// </summary>
        /// <param name="fileName"></param>
        /// <param name="hash">HMAC-SHA256(fileName + companyCode + ddMMyyyyHH (UTC time))</param>
        /// <returns></returns>
        [HttpGet]
