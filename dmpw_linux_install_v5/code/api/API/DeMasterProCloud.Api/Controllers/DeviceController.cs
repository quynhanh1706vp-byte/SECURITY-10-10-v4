...
namespace DeMasterProCloud.Api.Controllers
{
    ...
    public class DeviceController : Controller
    {
        ...
        /// <param name="hash">hash HMAC-SHA256 (msgId + rid + companyCode)</param>
        ...
        public IActionResult UploadLogDevice(string rid, string msgId, string hash, IFormFile file)
        {
            ...
            // Using company.SecretCode as the secret key ensures only authorized devices can upload logs
            if (string.IsNullOrEmpty(hash) || !CryptographyHelper.VerifyHmacSha256Hash(company.SecretCode, msgId + rid + company.Code, hash))
