...
namespace DeMasterProCloud.DataAccess.Models
{
    public partial class AppDbContext : DbContext
    {
        ...
        {
            // Connection string should be configured via dependency injection in Startup.cs
            // This fallback configuration has been removed for security reasons
            // If you see this error: "No database provider has been configured for this DbContext"
            // Make sure connection string is properly configured in appsettings.json and Startup.cs
