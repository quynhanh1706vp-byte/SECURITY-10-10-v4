...
{
    // SECURITY: False positive — no HttpClient or external HTTP calls are made in this class.
    // WebSocket `SendAsync` only sends data to already-authenticated clients over established connections.
    // No unvalidated URLs or SSRF risk present.
