...
namespace DeMasterProCloud.Common.Infrastructure
{
    ...
    public class PagePermission
    {
        ...
        public static Dictionary<string, Dictionary<string, bool>> GetCommonPermssions()
        {
            ...
            // Add firmware version page permission
            permissionList.Add(new FirmwareVersionPage().GetPageName(), new FirmwareVersionPage().GetPermissions());
    ...
    public class ActionName
    {
        ...
        public const string Update = "Update"; // this is action send request update firmware for device
    ...
    public class FirmwareVersionPage : PagePermissionClass
    {
        public const bool View = true;
        public const bool Add = false;
        public const bool Edit = false;
