    ...
    public class SystemInfoService : ISystemInfoService
    {
        ...
        public string VerifyLicense(VerifyLicenseModel model)
        {
            try
            {
                ...
                try
                {
                    // SECURITY: Safe usage — URL is from configuration (appsettings.json) + constant.
                    // No user-controlled input. Not vulnerable to SSRF. False positive warning for security scanner.
